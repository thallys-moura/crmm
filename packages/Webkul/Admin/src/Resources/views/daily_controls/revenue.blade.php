...
<v-daily_controls-revenue-stats>
    <!-- Shimmer -->
    <x-admin::shimmer.daily_controls.revenue />
</v-daily_controls-revenue-stats>
...
@pushOnce('scripts')
    <script
        ...
        id="v-daily_controls-revenue-stats-template"
    >
        <!-- Shimmer -->
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-2 rounded-lg border border-gray-200 px-4 py-5 dark:border-gray-800">
                            <p class="text-xs font-medium text-gray-600 dark:text-gray-300">
                                @lang('admin::app.daily_controls.revenue.won-revenue')
                            </p>
                        ...
                        <div class="flex flex-col gap-2 rounded-lg border border-gray-200 px-4 py-5 dark:border-gray-800">
                            <p class="text-xs font-medium text-gray-600 dark:text-gray-300">
                                @lang('admin::app.daily_controls.revenue.lost-revenue')
                            </p>
    ...
    <script type="module">
        app.component('v-daily_controls-revenue-stats', {
            template: '#v-daily_controls-revenue-stats-template',
